<template>
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <div class="dropdown no-arrow">
                        <a aria-expanded="false" aria-haspopup="true" class="dropdown-toggle btn btn-primary btn-sm" data-toggle="dropdown"
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="progress" style="height: 12px;">
                            <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="55" class="progress-bar bg-danger"
    ...
    <div class="row">
        <div class="col-lg-12 text-center">
            <p>Do you like this template ? you can download from <a class="btn btn-primary btn-sm"
                                                                    href="https://github.com/indrijunanda/RuangAdmin" target="_blank"><i
